...
@Component
public class WaiterPushWebSocketHandler extends TextWebSocketHandler {

	private final WaiterPushSessionRegistry registry;

	public WaiterPushWebSocketHandler(WaiterPushSessionRegistry registry) {
