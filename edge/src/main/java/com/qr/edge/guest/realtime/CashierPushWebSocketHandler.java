...
@Component
public class CashierPushWebSocketHandler extends TextWebSocketHandler {

	private final CashierPushSessionRegistry registry;

	public CashierPushWebSocketHandler(CashierPushSessionRegistry registry) {
